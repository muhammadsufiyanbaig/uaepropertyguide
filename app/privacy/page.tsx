      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-medium text-primary-dark mb-4">Privacy Policy</h1>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-primary-dark">UAE Property Guide Privacy Policy</CardTitle>
            </CardHeader>
            <CardContent className="prose max-w-none text-secondary-dark space-y-6">
              <div>
                <h2 className="text-xl font-medium text-primary-dark mb-3">1. Information We Collect</h2>
                <p>
              ...
              <div>
                <h2 className="text-xl font-medium text-primary-dark mb-3">2. How We Use Your Information</h2>
              ...
              <div>
                <h2 className="text-xl font-medium text-primary-dark mb-3">3. Information Sharing and Disclosure</h2>
              ...
              <div>
                <h2 className="text-xl font-medium text-primary-dark mb-3">4. Data Security</h2>
                <p>
              ...
              <div>
                <h2 className="text-xl font-medium text-primary-dark mb-3">5. Data Retention</h2>
                <p>
              ...
              <div>
                <h2 className="text-xl font-medium text-primary-dark mb-3">6. Your Rights and Choices</h2>
              ...
              <div>
                <h2 className="text-xl font-medium text-primary-dark mb-3">7. Cookies and Tracking Technologies</h2>
                <p>
              ...
              <div>
                <h2 className="text-xl font-medium text-primary-dark mb-3">8. Third-Party Links</h2>
                <p>
              ...
              <div>
                <h2 className="text-xl font-medium text-primary-dark mb-3">9. Children's Privacy</h2>
                <p>
              ...
              <div>
                <h2 className="text-xl font-medium text-primary-dark mb-3">10. Changes to This Privacy Policy</h2>
                <p>
              ...
              <div>
                <h2 className="text-xl font-medium text-primary-dark mb-3">11. Contact Us</h2>
                <p>
